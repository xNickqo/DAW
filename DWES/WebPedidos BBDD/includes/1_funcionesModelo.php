...
function verificarUsuario($conn, $customerNumber) {
    try {
        ...
        echo "Error en verficacion de usuario: " . $e->getMessage();
        return null;
    }
}
...
function consultarNumeroCliente($conn){
    try {
        ...
        echo "Error al obtener el numero de cliente disponible: " . $e->getMessage();
        return null;
    }
}
...
function insertarRegistro($conn, $customerNumber, $customerName, $contactLastName, $contactFirstName, $phone, $address, $address2, $city, $stateCode, $postalCode, $country,$salesRepEmployeeNumber, $creditLimit){
    try {
        ...
        echo "Error al insertar el registro de usuario: " . $e->getMessage();
    }
}
...
function generarNumeroPedido($conn){
    try {
        ...
        echo "Error al generar numero de pedido: " . $e->getMessage();
        return null;
    }
}
...
function obtenerPedidosPorCliente($conn, $customerNumber) {
    try{
        ...
        echo "Error al obtener las unidades vendidas: " . $e->getMessage();
        return null;
    }
}
...
function obtenerStockPorLinea($conn, $productLine) {
    try{
        ...
        echo "Error al obtener el stock por linea: " . $e->getMessage();
        return null;
    }
}
