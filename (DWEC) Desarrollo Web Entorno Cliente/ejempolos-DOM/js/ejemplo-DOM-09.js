...
function creacion(){
	...
	if (valorCaja.length > 0 && cajaValor.length > 0) {
		...
		while (inexis && indice < todos.length){
			...
			if (celdas[0].textContent == valorCaja && celdas[1].textContent == cajaValor)
				inexis=false
			else if (celdas[0].textContent > valorCaja){
				inexis=false;
			...
			} else if (celdas[0].textContent == valorCaja && celdas[1].textContent > cajaValor){
				inexis=false;
				let fila=document.createElement("tr");
				let col1=document.createElement("td");
				let col2=document.createElement("td");
