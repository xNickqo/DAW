...
*/
    ...
    if (res_esNifCif === 'C1') {
        ...
        error += "---[CIF] Se ha introducido un CIF erróneo. El carácter de control es erróneo\n";
    } else if (res_esNifCif === 'N1') {
        error += "";
    } else if (res_esNifCif === 'N2') {
        error += "---[NIF] Se ha introducido un NIF erróneo. El carácter de control es erróneo\n";
    } else if (res_esNifCif === 'N3') {
        error += "---[NIF] Se ha introducido un DNI, se ha pasado un número de entre 6 y 8 dígitos con un valor mínimo de 100000\n";
    } else if (res_esNifCif === 0) {
        error += "---[NIFCIF] Se ha introducido un dato no válido. No es CIF\n";
    }
...
*/
    ...
    if (numTrabEmpr === '' || !numTrabEmprRegex.test(numTrabEmpr))
        error += "---[numTrabEmpr] El número de trabajadores debe ser un número válido mayor que 0.\n";
    ...
    if (numFabEmp === '' || !numFabEmpRegex.test(numFabEmp))
        error += "---[numFabEmp] El número de fábricas debe ser un número válido mayor que 0.\n";
